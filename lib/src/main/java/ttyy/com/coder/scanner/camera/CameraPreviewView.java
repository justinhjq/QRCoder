 ...
 * Date  : 2016/12/08 13:31
 * Name  : CameraPreviewView
 * Intro : 相机预览View
...
public class CameraPreviewView extends SurfaceView implements SurfaceHolder.Callback{
    ...
    private QRCodeCameraConfigurationManager mCameraConfigurationManager;
    ...
    public void setCamera(Camera camera) {
        mCamera = camera;
        if (mCamera != null) {
            mCameraConfigurationManager = new QRCodeCameraConfigurationManager(getContext());
